...
app.post('/cadUsuario', (req, res) => {
  ...
  const sql = 'INSERT INTO nomes (nome_usuario) VALUES (?)';
  db.query(sql, [nome_usuario], (err, result) => {
    if (err) {
    ...
    // Em caso de sucesso encaminha uma mensagem e o id do usuário
